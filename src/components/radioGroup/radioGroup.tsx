  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        ...
        "data-[state=checked]:outline-4 data-[state=checked]:outline-blue-3 data-[state=checked]:outline-offset-[-2px] data-[state=checked]:border-blue-3",
        "active:scale-90",
        className
      )}
      {...props}
    >
      <RadioGroupPrimitive.Indicator className="grid place-content-center place-items-center">
        <div
          className="size-3 rounded-full bg-blue-3 transition-transform animate-in fade-in zoom-in-75"
        />

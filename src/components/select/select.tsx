...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-5 w-5 text-blue-3 fill-blue-3 shrink-0" />
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-[360px] mt-1 overflow-hidden rounded-md border-1 border-neutral-white-4 bg-neutral-white-1 text-popover-foreground shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out",
        className,
      )}
      position={position}
      sideOffset={3}
  ...
  >
    ...
    <span className="absolute right-4 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-blue-3 stroke-[3]" />
      </SelectPrimitive.ItemIndicator>
    </span>
  </SelectPrimitive.Item>
));
